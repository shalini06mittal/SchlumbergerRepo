...
public class CustomerDatabase {
	...
	public boolean insertCustomer(Customer customer) throws SQLIntegrityConstraintViolationException {
		// Ref of Statement
		try {
...
//			System.out.println(sql);
			...
			//e.printStackTrace();
			throw new SQLIntegrityConstraintViolationException("Email with that id already exists"); 
		}
		return true;
	...
	public String findCustomerByEmail(String email) throws Exception
	{
